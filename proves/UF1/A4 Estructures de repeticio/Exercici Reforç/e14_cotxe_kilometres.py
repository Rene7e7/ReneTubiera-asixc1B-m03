'''
e14.py
Un cotxe es troba al quilòmetre 70 d'una carretera, un altre es troba al km 150,
els cotxes tenen sentit oposat i tenen la mateixa velocitat, la qual es demanarà per teclat.
Realitzar un programa per determinar a quin quilòmetre d'aquesta carretera es trobaran.
